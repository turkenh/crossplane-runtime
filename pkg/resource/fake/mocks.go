...
func (m *ManagedResourceReferencer) SetResourceReference(r *reference.Composite) { m.Ref = r }

// GetResourceReference gets the ResourceReference.
func (m *ManagedResourceReferencer) GetResourceReference() *reference.Composite { return m.Ref }
